...
export const OPENJAM_LESSON_NAMES = {
  ...
  'person': {
    fa: ['اسامی شخصی', 'اعضای نزدیک خانواده', 'پدربزرگ و مادربزرگ', 'خواهر و برادر',
         ...
         'متخصص', 'آماتور', 'تازه‌وارد', 'استاد و خبره', 'بازنشسته'],
    en: ['Personal names', 'Close family members', 'Grandparents', 'Siblings',
         ...
         'Experts', 'Amateurs', 'Newcomers', 'Masters & experts', 'Retirees'],
  },
  'profession': {
    fa: ['شغل‌های پزشکی', 'شغل‌های آموزشی', 'شغل‌های فنی', 'شغل‌های مهندسی',
         ...
         'شغل‌های کشاورزی', 'شغل‌های صنعتی', 'شغل‌های حمل و نقل'],
    en: ['Medical jobs', 'Education jobs', 'Technical jobs', 'Engineering jobs',
         ...
         'Agriculture jobs', 'Industry jobs', 'Transport jobs'],
  },
  'relationship': {
    fa: ['دوستی', 'رابطه عاطفی', 'ازدواج', 'خویشاوندی',
         'روابط کاری', 'روابط همسایگی', 'روابط رسمی', 'دوستی صمیمی'],
    en: ['Friendship', 'Romantic relationships', 'Marriage', 'Kinship',
         'Work relationships', 'Neighborly relations', 'Formal relations', 'Close friendship'],
  },
  ...
  'health': {
    fa: ['بیماری‌های شایع', 'سرماخوردگی و آنفلوآنزا', 'سردرد و سرگیجه',
         ...
         'ورزش درمانی', 'تب و عفونت', 'ریه و قلب'],
    en: ['Common illnesses', 'Cold & flu', 'Headache & dizziness',
         ...
         'Therapeutic exercise', 'Fever & infection', 'Lungs & heart'],
  },
  ...
  'nature': {
    fa: ['آب‌وهوای روزانه', 'فصل‌ها', 'باد و طوفان', 'بارش و رطوبت', 'دما و گرما',
         ...
         'انرژی پاک', 'پدیده‌های طبیعی', 'اقیانوس', 'قمر و سیاره'],
    en: ['Daily weather', 'Seasons', 'Wind & storm', 'Rain & humidity', 'Temperature',
         ...
         'Clean energy', 'Natural phenomena', 'Ocean', 'Moon & planets'],
  },
  'animal': {
  ...
  'tool': {
    fa: ['ابزار آشپزخانه', 'ابزار باغبانی', 'ابزار تعمیر', 'ابزار نقاشی',
         ...
         'ابزار ساختمانی', 'ابزار خیاطی', 'ابزار آرایش', 'ابزار سرگرمی'],
    en: ['Kitchen tools', 'Garden tools', 'Repair tools', 'Painting tools',
         ...
         'Construction tools', 'Sewing tools', 'Cosmetic tools', 'Hobby tools'],
  },
  ...
  'work': {
    fa: ['مدیریت', 'بازاریابی', 'فروش', 'حسابداری', 'منابع انسانی',
         ...
         'سرگرمی', 'ورزش', 'خدمات اجتماعی', 'مهارت‌های نرم'],
  ...
  'society': {
    fa: ['حکومت و دولت', 'سیاست', 'انتخابات', 'مجلس و پارلمان', 'وزارت',
         ...
         'سازمان‌های بین‌المللی', 'سیاست خارجی'],
    en: ['Government & state', 'Politics', 'Elections', 'Parliament', 'Ministry',
         ...
         'International organizations', 'Foreign policy'],
  },
  'religion': {
  ...
  'action': {
    fa: ['حرکت و جابجایی', 'راه رفتن و دویدن', 'پریدن و خیز برداشتن',
         ...
         'جستجو و یافتن', 'تغییر و تحول', 'درمان و مراقبت', 'مدیریت و سرپرستی',
         'سازماندهی و چینش', 'ارزیابی و قضاوت', 'آرایش و زیبایی',
         'کشاورزی و باغبانی', 'ساخت و ساز', 'عبادت و نماز', 'سفر و گردش',
         'خرید و فروش جزئی', 'ضمانت و تأمین', 'ابراز ادب'],
    en: ['Movement', 'Walking & running', 'Jumping & leaping',
         ...
         'Searching', 'Changing', 'Treating & caring', 'Managing & supervising',
         'Organizing & arranging', 'Evaluating & judging', 'Grooming & beautifying',
         'Farming & gardening', 'Building & construction', 'Worshipping & praying',
         'Touring & sightseeing', 'Retail trading', 'Guaranteeing', 'Showing courtesy'],
  },
  'event': {
    fa: ['جشن تولد', 'عروسی', 'کنفرانس', 'مسابقه ورزشی', 'کنسرت',
         'نمایشگاه', 'جشنواره', 'تعطیلات ملی', 'اعیاد مذهبی',
         'مراسم سوگ', 'گردهمایی خانوادگی', 'رویدادهای علمی', 'گردهمایی محلی'],
    en: ['Birthday party', 'Wedding', 'Conference', 'Sports match', 'Concert',
         'Exhibition', 'Festival', 'National holidays', 'Religious holidays',
         'Mourning ceremonies', 'Family gatherings', 'Scientific events', 'Local gatherings'],
  },
  ...
  'emotion': {
    fa: ['شادی و خوشحالی', 'غم و اندوه', 'خشم و عصبانیت', 'ترس و وحشت',
         ...
         'کنترل احساس', 'همدلی', 'خشنودی و رضایت', 'سرخوردگی', 'دلتنگی'],
    en: ['Joy & happiness', 'Sadness & grief', 'Anger', 'Fear & terror',
         ...
         'Emotion control', 'Empathy', 'Satisfaction', 'Frustration', 'Yearning'],
  },
  'quality': {
    fa: ['اندازه - بزرگ و کوچک', 'اندازه - عرض و طول', 'اندازه - ارتفاع',
         ...
         'عمیق و سطحی', 'روان و خشک', 'مهم و فرعی', 'نزدیک و دور احساسی',
         'واضح و مبهم', 'صحیح و معیوب', 'ضروری و اختیاری', 'لطیف و خشن', 'کارآمد و ناکارآمد'],
    en: ['Size - big & small', 'Size - width & length', 'Size - height',
         ...
         'Deep & shallow', 'Fluid & dry', 'Important & secondary', 'Emotionally near & far',
         'Clear & vague', 'Correct & faulty', 'Necessary & optional', 'Soft & rough', 'Efficient & inefficient'],
  },
  'abstract': {
    fa: ['زمان و دوران', 'مکان و فضا', 'کمیت و عدد', 'ترتیب و توالی',
         ...
         'وحدت و تعدد', 'مرکز و حاشیه', 'نسبت و تناسب', 'فرآیند و رخداد', 'تجربه و دانش'],
    en: ['Time & era', 'Place & space', 'Quantity & number', 'Order & sequence',
         ...
         'Oneness & multiplicity', 'Center & periphery', 'Ratio & proportion', 'Process & event', 'Experience & knowledge'],
  },
