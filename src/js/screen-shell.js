...
import { initI18n, setLocale, getLocale, supportedLocales } from './i18n.js?v=mpr8ll1n';
import { initTheme, setTheme, getTheme } from './theme.js?v=mpr8ll1n';
import { initAudio } from './audio.js?v=mpr8ll1n';
import { injectStamps } from './hero.js?v=mpr8ll1n';
import { injectNavs } from './bottomnav.js?v=mpr8ll1n';
import { mountAllStages } from './lottie.js?v=mpr8ll1n';
import './popup.js?v=mpr8ll1n';  // side-effect: registers window.showPopup
