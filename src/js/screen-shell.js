...
import { initI18n, setLocale, getLocale, supportedLocales } from './i18n.js?v=mpr8xla8';
import { initTheme, setTheme, getTheme } from './theme.js?v=mpr8xla8';
import { initAudio } from './audio.js?v=mpr8xla8';
import { injectStamps } from './hero.js?v=mpr8xla8';
import { injectNavs } from './bottomnav.js?v=mpr8xla8';
import { mountAllStages } from './lottie.js?v=mpr8xla8';
import './popup.js?v=mpr8xla8';  // side-effect: registers window.showPopup
