...
import { initI18n, setLocale, getLocale, supportedLocales } from './i18n.js?v=mppxtz6a';
import { initTheme, setTheme, getTheme } from './theme.js?v=mppxtz6a';
import { initAudio } from './audio.js?v=mppxtz6a';
import { injectStamps } from './hero.js?v=mppxtz6a';
import { injectNavs } from './bottomnav.js?v=mppxtz6a';
import { mountAllStages } from './lottie.js?v=mppxtz6a';
import './popup.js?v=mppxtz6a';  // side-effect: registers window.showPopup
