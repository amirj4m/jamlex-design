...
import { initI18n, setLocale, getLocale, supportedLocales } from './i18n.js?v=mppkusee';
import { initTheme, setTheme, getTheme } from './theme.js?v=mppkusee';
import { initAudio } from './audio.js?v=mppkusee';
import { injectStamps } from './hero.js?v=mppkusee';
import { injectNavs } from './bottomnav.js?v=mppkusee';
import { mountAllStages } from './lottie.js?v=mppkusee';
import './popup.js?v=mppkusee';  // side-effect: registers window.showPopup
